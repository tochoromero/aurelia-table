          ...
          return i.prototype.toString = function() {
            ...
            if (e > 1) {
              ...
              for (n = 0; e - 1 > n; ++n) {
                var o = arguments[n];
                if (!h.isObject(o))
                  return p("expecting an object but got " + h.classString(o));
                r[i++] = o;
              }
            ...
            if (0 !== (50397184 & u)) {
              ...
              0 !== (33554432 & u) ? (h = l._rejectionHandler0, f = t) : 0 !== (16777216 & u) ? (h = l._fulfillmentHandler0, f = e, l._unsetRejectionIsUnhandled()) : (_ = l._settlePromiseLateCancellationObserver, h = new m("late cancellation observer"), l._attachExtraTrace(h), f = e), v.invoke(_, l, {
            ...
            if (0 === (65536 & i)) {
              r._pushContext();
              var o;
              e === C ? n && "number" == typeof n.length ? o = S(t).apply(this._boundValue(), n) : (o = R, o.e = new g("cannot .spread() a non-array: " + h.classString(n))) : o = S(t).call(e, n);
              var a = r._popContext();
              i = r._bitField, 0 === (65536 & i) && (o === k ? r._reject(n) : o === R ? r._rejectCallback(o.e, !1) : (F.checkForgottenReturns(o, a, "", r, this), r._resolveCallback(o)));
            }
