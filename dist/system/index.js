...
System.register(['./au-table', './au-table-pagination', './au-table-select', './au-table-sort', 'aurelia-framework'], function (_export, _context) {
  "use strict";

  var AureliaTableCustomAttribute, AutPaginationCustomElement, AutSelectCustomAttribute, AutSortCustomAttribute, PLATFORM;
